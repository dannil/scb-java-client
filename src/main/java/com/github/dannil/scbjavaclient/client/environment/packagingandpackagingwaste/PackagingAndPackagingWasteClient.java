 ...
 * @since 0.2.0
 */
public class PackagingAndPackagingWasteClient extends AbstractClient {

    /**
     * <p>Default constructor.</p>
     */
    public PackagingAndPackagingWasteClient() {
        super();
    }
     ...
     */
    public PackagingAndPackagingWasteClient(Locale locale) {
        super(locale);
    }
    ...
    public URLEndpoint getUrl() {
        return getRootUrl().append("MI/MI0307/");
    }
