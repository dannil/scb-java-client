...
public class TransportClient extends AbstractContainerClient {
    ...
    public TransportClient() {
        ...
        addClient("registeredvehicles", new RegisteredVehiclesClient());
    }
     ...
     */
    public RegisteredVehiclesClient registeredVehicles() {
        return (RegisteredVehiclesClient) getClient("registeredvehicles");
    }
