 ...
 * @since 0.3.0
 */
public class StatementAccountsCountyClient extends AbstractClient {

    /**
     * <p>Default constructor.</p>
     */
    public StatementAccountsCountyClient() {
        super();
    }
     ...
     */
    public StatementAccountsCountyClient(Locale locale) {
        super(locale);
    }
