 ...
 * @since 0.3.0
 */
public class BalanceSheetMunicipalityClient extends AbstractClient {

    /**
     * <p>Default constructor.</p>
     */
    public BalanceSheetMunicipalityClient() {
        super();
    }
     ...
     */
    public BalanceSheetMunicipalityClient(Locale locale) {
        super(locale);
    }
