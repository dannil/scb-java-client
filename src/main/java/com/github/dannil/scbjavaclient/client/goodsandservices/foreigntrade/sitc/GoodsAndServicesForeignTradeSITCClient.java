...
/**
 * <p>Client which handles goods and services foreign trade SITC (Standard International
...
public class GoodsAndServicesForeignTradeSITCClient extends AbstractClient {
     ...
     */
    public GoodsAndServicesForeignTradeSITCClient() {
        super();
    }
     ...
     */
    public GoodsAndServicesForeignTradeSITCClient(Locale locale) {
        super(locale);
    }
