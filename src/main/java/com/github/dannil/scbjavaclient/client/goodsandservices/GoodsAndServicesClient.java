...
import com.github.dannil.scbjavaclient.client.goodsandservices.foodsales.FoodSalesClient;
import com.github.dannil.scbjavaclient.client.goodsandservices.foreigntrade.ForeignTradeClient;
...
public class GoodsAndServicesClient extends AbstractContainerClient {
    ...
    public GoodsAndServicesClient() {
        ...
        addClient("foodsales", new FoodSalesClient());
        addClient("foreigntrade", new ForeignTradeClient());
    }
     ...
     */
    public FoodSalesClient foodSales() {
        return (FoodSalesClient) getClient("foodsales");
    }
     ...
     */
    public ForeignTradeClient foreignTrade() {
        return (ForeignTradeClient) getClient("foreigntrade");
    }
