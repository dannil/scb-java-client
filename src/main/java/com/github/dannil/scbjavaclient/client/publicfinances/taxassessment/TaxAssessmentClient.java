 ...
 * @since 0.3.0
 */
public class TaxAssessmentClient extends AbstractClient {

    /**
     * <p>Default constructor.</p>
     */
    public TaxAssessmentClient() {
        super();
    }
     ...
     */
    public TaxAssessmentClient(Locale locale) {
        super(locale);
    }
    ...
    public List<ResponseModel> getAssessmentForNationalCapitalIncomeTax(Collection<String> regions,
        ...
        return getResponseModels("KapInkomsterA", mappings);
    }
