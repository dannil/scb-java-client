 ...
 * @since 0.3.0
 */
public class LatestAssumptionsClient extends AbstractClient {

    /**
     * <p>Default constructor.</p>
     */
    public LatestAssumptionsClient() {
        super();
    }
     ...
     */
    public LatestAssumptionsClient(Locale locale) {
        super(locale);
    }
    ...
    public List<ResponseModel> getDeathRate(Collection<Integer> sexes, Collection<String> ages,
        ...
        return getResponseModels("BefProgDodstal16", mappings);
    }
    ...
    public List<ResponseModel> getFertilityAssumption(Collection<Integer> years) {
        ...
        return getResponseModels("BefProgFruktTot16", mappings);
    }
