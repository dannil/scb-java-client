...
public class PricesAndConsumptionPPISPIN2007YearClient extends AbstractClient {
     ...
     *         objects
     */
    public List<ResponseModel> getProducerPriceIndexHomeSales(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "HMPIAr07");
    }
     ...
     *         objects
     */
    public List<ResponseModel> getExportPriceIndex(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "EXPIAr07");
    }
     ...
     *         objects
     */
    public List<ResponseModel> getImportPriceIndex(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "IMPIAr07");
    }
     ...
     *         objects
     */
    public List<ResponseModel> getProducerPriceIndex(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "PPIAr07");
    }
     ...
     *         objects
     */
    public List<ResponseModel> getPriceIndexForDomesticSupply(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "ITPIAr07");
    }
     ...
     *         objects
     */
    public List<ResponseModel> getWeightsForDifferentIndices(Collection<String> spin2007s, Collection<Integer> years) {
        return generate(spin2007s, years, "PPIviktB");
    }
    ...
    public List<ResponseModel> getProducerPriceIndexForServices(Collection<String> spin2007s,
        ...
        return generate(spin2007s, years, "TPI2005Ar07");
    }
     ...
     *         {@link com.github.dannil.scbjavaclient.model.ResponseModel ResponseModel}
     */
    private List<ResponseModel> generate(Collection<String> spin2007s, Collection<Integer> times, String table) {
