...
public class PricesAndConsumptionCPIHICPClient extends AbstractClient {
    ...
    /**
     * <p>Fetch all harmonized index CT annual changes data.</p>
     *
     * @return the data wrapped in a list of
     *         {@link com.github.dannil.scbjavaclient.model.ResponseModel ResponseModel}
     *         objects
     *
     * @see #getHarmonizedIndexCTAnnualChanges(Collection)
     */
    public List<ResponseModel> getHarmonizedIndexCTAnnualChanges() {
        return getHarmonizedIndexCTAnnualChanges(null);
    }

    /**
     * <p>Fetch all harmonized index CT annual changes data which match the input
     * constraints.</p>
     *
     * @param months
     *            the months
     ...
     *         objects
     */
    public List<ResponseModel> getHarmonizedIndexCTAnnualChanges(Collection<String> months) {
        return generate(months, "HIKPCTF12MP2015");
    }

    /**
     * <p>Fetch all harmonized index CT monthly changes data.</p>
     *
     * @return the data wrapped in a list of
     *         {@link com.github.dannil.scbjavaclient.model.ResponseModel ResponseModel}
     *         objects
     *
     * @see #getHarmonizedIndexCTMonthlyChanges(Collection)
     */
    public List<ResponseModel> getHarmonizedIndexCTMonthlyChanges() {
        return getHarmonizedIndexCTMonthlyChanges(null);
    }

    /**
     * <p>Fetch all harmonized index CT monthly changes data which match the input
     * constraints.</p>
     *
     * @param months
     *            the months
     ...
     *         objects
     */
    public List<ResponseModel> getHarmonizedIndexCTMonthlyChanges(Collection<String> months) {
        return generate(months, "HIKPCTFFMP2015");
    }

    /**
     * <p>Fetch all harmonized index CT months data.</p>
     *
     * @return the data wrapped in a list of
     *         {@link com.github.dannil.scbjavaclient.model.ResponseModel ResponseModel}
     *         objects
     *
     * @see #getHarmonizedIndexCTMonths(Collection)
     */
    public List<ResponseModel> getHarmonizedIndexCTMonths() {
        return getHarmonizedIndexCTMonths(null);
    }

    /**
     * <p>Fetch all harmonized index CT months data which match the input constraints.</p>
     *
     * @param months
     *            the months
     * @return the data wrapped in a list of
     ...
     *         objects
     */
    public List<ResponseModel> getHarmonizedIndexCTMonths(Collection<String> months) {
        return generate(months, "HIKPCTIND22015");
    }

    /**
     * <p>Fetch all harmonized index CT years data.</p>
     *
     * @return the data wrapped in a list of
     *         {@link com.github.dannil.scbjavaclient.model.ResponseModel ResponseModel}
     *         objects
     *
     * @see #getHarmonizedIndexCTYears(Collection)
     */
    public List<ResponseModel> getHarmonizedIndexCTYears() {
        return getHarmonizedIndexCTYears(null);
    }

    /**
     * <p>Fetch all harmonized index CT years data which match the input constraints.</p>
     *
     * @param years
     *            the years
     * @return the data wrapped in a list of
     ...
     *         objects
     */
    public List<ResponseModel> getHarmonizedIndexCTYears(Collection<Integer> years) {
        return generate(years, "HIKPCTAR22015");
    }
