...
/**
 * <p>Model for fertility rate.</p>
 *
 * @since 0.1.0
 */
public class FertilityRate extends AbstractRegionTimeAndValueModel<String, Integer, Double> {
    ...
    public static Map<String, Collection<String>> getInputs() {
        ...
        String response = get.getBodyFromTable("BE/BE0701/FruktsamhetSumNy");
