...
public class LiveBirth extends AbstractRegionYearAndValueModel<String, Integer, Long> {
	...
	/**
	 * <p>Get the available codes and their respective values for the live birth data from the
	 * API.</p>
	 *
	...
	public static Map<String, Collection<String>> getInputs() {
		...
		String response = get.getBodyAsStringFromTable("BE/BE0101/BE0101H/FoddaK");
