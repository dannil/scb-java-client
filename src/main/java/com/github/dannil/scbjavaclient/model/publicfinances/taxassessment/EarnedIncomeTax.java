...
/**
 * <p>Model for earned income tax rate data.</p>
 *
 * @since 0.2.1
 */
public class EarnedIncomeTax extends IncomeTax {

    /**
     * <p>Default constructor.</p>
     */
    public EarnedIncomeTax() {
        super();
    }
    ...
    public static Map<String, Collection<String>> getInputs() {
        ...
        String response = get.getBodyFromTable("OE/OE0701/ForvInkomsterA");
