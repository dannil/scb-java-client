...
public class FinanceInvestmentFundsClientIT extends RemoteIntegrationTestSuite {

    private FinanceInvestmentFundsClient client;

    @Before
    public void setup() {
        this.client = new SCBClient().finance().investmentFunds();
    }
