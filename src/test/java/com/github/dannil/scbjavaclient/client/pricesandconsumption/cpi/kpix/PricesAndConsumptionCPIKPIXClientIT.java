...
public class PricesAndConsumptionCPIKPIXClientIT extends RemoteIntegrationTestSuite {

    private PricesAndConsumptionCPIKPIXClient client;

    @Before
    public void setup() {
        this.client = new SCBClient().pricesAndConsumption().cpi().kpix();
    }
