...
public class AccomodationStatisticsClientTest {

    @Test
    public void createWithLocaleConstructor() {
        Locale locale = new Locale("sv", "SE");
        AccomodationStatisticsClient client = new AccomodationStatisticsClient(locale);
    ...
    public void monthClient() {
        AccomodationStatisticsClient client = new AccomodationStatisticsClient();

        assertEquals(client.month().getClass(), MonthClient.class);
    }
    ...
    public void yearClient() {
        ...
        assertEquals(client.year().getClass(), YearClient.class);
    }
