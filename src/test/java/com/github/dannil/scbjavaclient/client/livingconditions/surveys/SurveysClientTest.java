...
public class SurveysClientTest {

    @Test
    public void createWithLocaleConstructor() {
        Locale locale = new Locale("sv", "SE");
        SurveysClient client = new SurveysClient(locale);
    ...
    public void employmentClient() {
        SurveysClient client = new SurveysClient();

        assertEquals(client.employment().getClass(), EmploymentClient.class);
    }
    ...
    public void healthClient() {
        ...
        assertEquals(client.health().getClass(), HealthClient.class);
    }
