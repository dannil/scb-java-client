...
public class PopulationDemographyClient_GetFertilityRate extends RemoteIntegrationTestSuite {
	...
	private PopulationDemographyClient_GetFertilityRate() {
		this.populationDemographyClient = new SCBClient().population().demography();
	}

	public PopulationDemographyClient_GetFertilityRate(List<String> regions, List<Integer> genders, List<Integer> years) {
		this();
	...
	public void getFertilityRate() {
		assertNotEquals(0, this.populationDemographyClient.getFertilityRate(this.regions, this.genders, this.years).size());
	}
