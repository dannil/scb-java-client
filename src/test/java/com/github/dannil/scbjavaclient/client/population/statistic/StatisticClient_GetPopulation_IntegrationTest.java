...
public class StatisticClient_GetPopulation_IntegrationTest extends RemoteIntegrationTestSuite {
	...
	private StatisticClient_GetPopulation_IntegrationTest() {
		this.statisticsClient = new SCBClient().population().statistic();
	}

	public StatisticClient_GetPopulation_IntegrationTest(List<String> regions, List<String> statuses, List<String> ages,
