...
public class AmountClientIT extends RemoteIntegrationTestSuite {

    private AmountClient amountClient;

    @Before
    public void setup() {
        this.amountClient = new SCBClient().population().amount();
    }

    @Test
    public void getPopulation() {
        assertNotEquals(0, this.amountClient.getPopulation().size());
    }
    ...
    public void getPopulationWithParameters() {
        ...
        assertNotEquals(0, this.amountClient.getPopulation(regions, statuses, ages, genders, years).size());
    }
