...
public class AverageAgeClientIT extends RemoteIntegrationTestSuite {
    ...
    private AverageAgeClient averageAgeClient;

    @Before
    public void setup() {
        this.averageAgeClient = new SCBClient().population().averageAge();
    }

    @Test
    public void getAverageAge() {
        assertNotEquals(0, this.averageAgeClient.getAverageAge().size());
    }
    ...
    public void getAverageAgeWithParameters() {
        ...
        assertNotEquals(0, this.averageAgeClient.getAverageAge(regions, genders, years).size());
    }
}
