...
public class GoodsAndServicesForeignTradeSITCClientIT extends RemoteIntegrationTestSuite {

    private GoodsAndServicesForeignTradeSITCClient client;

    @Before
    public void setup() {
        this.client = new GoodsAndServicesForeignTradeSITCClient();
    }
