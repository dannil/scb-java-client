...
public class GoodsAndServicesForeignTradeTotalClientTest {

    @Test
    public void createWithLocaleConstructor() {
        Locale locale = new Locale("sv", "SE");
        GoodsAndServicesForeignTradeTotalClient client = new GoodsAndServicesForeignTradeTotalClient(locale);
