...
public class FinanceShareholdersClientIT extends RemoteIntegrationTestSuite {

    private FinanceShareholdersClient client;

    @Before
    public void setup() {
        this.client = new SCBClient().finance().shareholders();
    }
