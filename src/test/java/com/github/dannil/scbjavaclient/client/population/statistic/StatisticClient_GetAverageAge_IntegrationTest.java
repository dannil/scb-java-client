...
public class StatisticClient_GetAverageAge_IntegrationTest extends RemoteIntegrationTestSuite {
	...
	private StatisticClient_GetAverageAge_IntegrationTest() {
		this.statisticsClient = new SCBClient().population().statistic();
	}

	public StatisticClient_GetAverageAge_IntegrationTest(List<String> regions, List<String> genders, List<Integer> years) {
		this();
