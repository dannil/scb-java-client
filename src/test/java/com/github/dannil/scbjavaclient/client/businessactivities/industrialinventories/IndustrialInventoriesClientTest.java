...
public class IndustrialInventoriesClientTest {

    @Test
    public void createWithLocaleConstructor() {
        Locale locale = new Locale("sv", "SE");
        IndustrialInventoriesClient client = new IndustrialInventoriesClient(locale);
    ...
    public void economicIndicatorsClient() {
        IndustrialInventoriesClient client = new IndustrialInventoriesClient();
    ...
    public void inventoriesClient() {
        ...
        assertEquals(client.inventories().getClass(), InventoriesClient.class);
    }
