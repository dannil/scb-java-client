...
public class SCBPopulationAPI_IntegrationTest {
	...
	public final void getPopulationForRegionsNotNull() {
		Assert.assertNotEquals(0, this.statisticsAPI.getPopulation(this.regionCodes, null, null, null, null).size());
	}

	@Test
	public final void getPopulationForRegionAndYearsNotNull() {
		Assert.assertNotEquals(0, this.statisticsAPI.getPopulation(this.regionCodes, null, null, null, this.years).size());
	}
